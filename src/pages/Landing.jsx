    ...
    <section style={{
      ...
      <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: 780 }}>
        ...
        <div className="anim-fade-up delay-2" style={{
          ...
          background: "var(--yellow-dim)", border: "1px solid rgba(240,192,47,0.25)",
        ...
        {/* Headline */}
        <h1 className="anim-fade-up delay-3" style={{
          fontFamily: "var(--font-display)", fontWeight: 900,
        ...
        <p className="anim-fade-up delay-4" style={{
          ...
          fontWeight: 300, lineHeight: 1.7, maxWidth: 560, margin: "0 auto 3rem",
        }}>
          El CRM diseñado para que UNID gestione, acompañe e inscriba
          a sus prospectos con precisión institucional y visibilidad total.
        </p>
        ...
        <div className="anim-fade-up delay-5" style={{
          ...
          <button style={{
            ...
            transition: "all 0.25s", boxShadow: "0 4px 30px rgba(240,192,47,0.35)",
          ...
          <a href="#beneficios" style={{
            ...
            padding: "0.9rem 2rem", fontFamily: "var(--font-body)",
        ...
        <div style={{
          ...
          marginTop: "4.5rem", paddingTop: "2.5rem",
          ...
          {[
            ...
            <div key={stat.label} style={{ textAlign: "center" }}>
              <div style={{
                fontFamily: "var(--font-display)", fontWeight: 900,
                fontSize: "2rem", color: "var(--yellow)", lineHeight: 1,
              }}>{stat.val}</div>
...
function Benefits() {
  ...
  return (
    <section id="beneficios" style={{ padding: "7rem 2rem", background: "var(--navy-mid)", position: "relative" }}>
      <div style={{
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          <div style={{
            ...
            color: "var(--yellow)", letterSpacing: "0.14em", textTransform: "uppercase", marginBottom: "1rem",
          }}>¿Por qué UNID CRM?</div>
          <h2 style={{
          ...
          {BENEFITS.map((b, i) => (
            <div key={i}
              ...
              style={{
                ...
                border: hovered === i ? "1px solid rgba(240,192,47,0.30)" : "1px solid var(--navy-border)",
              ...
              <div style={{
                ...
                background: hovered === i ? "rgba(240,192,47,0.2)" : "rgba(240,192,47,0.08)",
                display: "flex", alignItems: "center", justifyContent: "center",
                color: "var(--yellow)", marginBottom: "1.2rem", transition: "all 0.3s",
              }}>
                {b.icon}
              </div>
              <h3 style={{
                fontFamily: "var(--font-display)", fontWeight: 700,
                fontSize: "1.05rem", color: "#fff", marginBottom: "0.6rem",
              }}>{b.title}</h3>
...
function HowItWorks() {
  return (
    <section style={{ padding: "7rem 2rem", background: "var(--navy)", position: "relative", overflow: "hidden" }}>
      <div style={{
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          ...
          <div>
            ...
            <div style={{
              display: "inline-flex", alignItems: "center", gap: "0.5rem",
              background: "var(--yellow-dim)", border: "1px solid rgba(240,192,47,0.2)",
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {STEPS.map((step, i) => (
              <div key={i} style={{ display: "flex", gap: "1.2rem", position: "relative" }}>
                {i < STEPS.length - 1 && (
                  <div style={{
                ...
                <div style={{
                  ...
                  background: "linear-gradient(135deg, rgba(240,192,47,0.15) 0%, rgba(240,192,47,0.05) 100%)",
                  border: "1px solid rgba(240,192,47,0.25)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontFamily: "var(--font-display)", fontWeight: 900, fontSize: "0.9rem",
                  color: "var(--yellow)", position: "relative", zIndex: 1,
                }}>{step.num}</div>
                <div style={{ paddingBottom: "2rem" }}>
                  <div style={{ fontWeight: 600, fontSize: "0.95rem", color: "#fff", marginBottom: "0.3rem", paddingTop: "0.9rem" }}>
                    {step.label}
                  </div>
                  <div style={{ fontSize: "0.82rem", color: "var(--text-muted)", lineHeight: 1.6 }}>{step.sub}</div>
                </div>
              </div>
            ))}
          </div>
...
function AccessCTA({ onLogin }) {
  return (
    <section style={{ padding: "6rem 2rem", background: "var(--navy-mid)", position: "relative", overflow: "hidden" }}>
      <div style={{
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: "1.05rem", lineHeight: 1.7, marginBottom: "3rem" }}>
          Accede al sistema con tus credenciales institucionales y empieza
          a gestionar prospectos con toda la precisión que UNID merece.
        </p>
        <button style={{
          background: "linear-gradient(135deg, #f0c02f 0%, #ffd040 60%, #d4a820 100%)",
          color: "var(--navy)", border: "none", borderRadius: 14,
          padding: "1.1rem 3rem", fontFamily: "var(--font-body)",
          fontWeight: 700, fontSize: "1.1rem", cursor: "pointer",
          transition: "all 0.25s", boxShadow: "0 6px 40px rgba(240,192,47,0.4)",
        ...
        <p style={{ marginTop: "1.5rem", fontSize: "0.78rem", color: "var(--text-muted)" }}>
          Acceso exclusivo para personal UNID autorizado · Soporte institucional disponible
        </p>
      </div>
    </section>
  );
  ...
  return (
    <footer style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.6rem" }}>
        <div style={{
          width: 28, height: 28, borderRadius: 6, background: "var(--yellow)",
          display: "flex", alignItems: "center", justifyContent: "center",
        }}>
      ...
      <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>
        © {new Date().getFullYear()} Universidad UNID — Sistema de Gestión Universitaria · Módulo 8
      </div>
